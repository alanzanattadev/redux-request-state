...
export function RequestStateConnecter(mapPropsToRequestID: (props: any) => string) {
  return function(WrappedComponent) {
    return class Enhanced extends React.Component {
      render() {
        return (
          <WrappedComponent state={getStateOfRequestID(this.props.requests, mapPropsToRequestID(this.props))} details={getDetailsOfRequestID(this.props.requests, mapPropsToRequestID(this.props))} {...this.props}/>
        )
      }
    }
  }
